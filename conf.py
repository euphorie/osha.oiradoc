...
# the sidebar.
html_logo = '.static/logo_oira.png'
...
latex_documents = [
  ('index', 'oira.tex', 'OiRA Documentation',
   'European Agency for Safety and Health at Work', 'manual'),
]

# The name of an image file (relative to this directory) to place at the
# top of the title page.
latex_logo = '.static/logo_oira.png'
